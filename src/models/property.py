...
class TargetProperty(PropertyBase):
    ...
    material_quality: Optional[str] = None  # качественные_фото_видео | качественные_фото | только_рендеры | только_планировка
    ownership_status: Optional[str] = None  # 1_собственник_без_обременений | 1+_собственников_без_обременений | ипотека_рассрочка | есть_обременения
