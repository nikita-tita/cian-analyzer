        ...
        if not street_url and str(self.region_code) == '1':  # Только для Москвы (region_code может быть str или int)
            ...
            if not target_okrug and target_metro:
                ...
                METRO_TO_OKRUG = {
                    ...
                    'косино': 'ЮВАО', 'улица дмитриевского': 'ЮВАО', 'лухмановская': 'ЮВАО', 'юго-восточная': 'ЮВАО',
                    ...
                    'лихоборы': 'САО', 'балтийская': 'САО', 'стрешнево': 'САО',
                    ...
                    'молодёжная': 'ЗАО', 'крылатское': 'ЗАО', 'строгино': 'ЗАО', 'мякинино': 'ЗАО',
