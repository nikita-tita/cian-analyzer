...
const ERROR_MESSAGES = {
    ...
    'invalid_url': {
        ...
        message: 'Введите корректную ссылку на объявление с ЦИАН'
    },
    'invalid_cian_url': {
        title: 'Ссылка не распознана',
        message: 'Введите ссылку на объявление ЦИАН, например: https://www.cian.ru/sale/flat/123456789/'
    },
    'invalid_price': {
    ...
    'captcha_required': {
        ...
        message: 'Сайт ЦИАН требует подтверждение. Попробуйте через несколько минут.'
    },
    'content_blocked': {
        title: 'Контент недоступен',
        message: 'Не удалось получить данные страницы. Попробуйте другой объект или повторите позже.'
    },
    'parsing_incomplete': {
    ...
    'insufficient_comparables': {
        title: 'Мало аналогов',
        message: 'Недостаточно аналогов для точного анализа. Добавьте объекты вручную через кнопку «Добавить по ссылке» или продолжите с имеющимися данными.'
    },
    'invalid_price_data': {
